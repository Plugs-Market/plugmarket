    ...
    <div className="px-4 py-6 pb-24 max-w-2xl mx-auto">
      ...
      <div className="space-y-4">
        <a
          ...
          className="flex items-center gap-4 p-4 rounded-lg bg-card card-gold-border hover:gold-shadow transition-shadow"
        >
        ...
        <a
          href="mailto:contact@allfarmz.com"
          className="flex items-center gap-4 p-4 rounded-lg bg-card card-gold-border hover:gold-shadow transition-shadow"
        >
          <Mail className="text-primary" size={24} />
          <div>
            <p className="text-foreground font-medium">Email</p>
            <p className="text-muted-foreground text-sm">contact@allfarmz.com</p>
          </div>
        </a>
        <a
          href="#"
