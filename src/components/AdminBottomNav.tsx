import { LayoutDashboard, Users, ArrowLeft, Store, Bot, HelpCircle, Globe, LucideIcon } from "lucide-react";

export type AdminTab = "dashboard" | "users" | "shop" | "telegram" | "faq" | "website";
